                ...
                <nav class="navbar navbar-expand-lg header-nav nav-transparent">
                    ...
                    <div class="main-menu-wrapper">
                        ...
                        <ul class="main-nav black-font">
                            <li class="has-submenu {{request()->is('/')=='true'?'active':''}}">
                                <a href="{{url('/')}}" >Home </a>
                            </li>
                        </ul>
                    </div>
                    <ul class="nav header-navbar-rht">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn-five" href="{{ url('dashboard') }}">Dashboard</a>
                        </li>
                        @elseif(Auth::user()->role == 'doctor')
                            <li class="nav-item">
                                <a class="nav-link btn-five" href="{{ url('doctor_dashboard') }}">Dashboard</a>
                            </li>
                        @elseif(Auth::user()->role == 'patient')
                            <li class="nav-item">
                                <a class="nav-link btn-five" href="{{ url('patient_dashboard') }}">Dashboard</a>
                            </li>
                        @endif
                        @else
                            <li class="nav-item">
                        ...
                        <div class="footer-widget footer-contact">
                            ...
                            <div class="footer-contact-info">
                                ...
                                <p class="mb-0"><i class="feather-mail"></i>
                                    <a href="#" class="__cf_email__" data-cfemail="771318141402051237120f161a071b125914181a">[email&#160;protected]</a>
                                </p>
                            </div>
                        </div>
                    </div>
