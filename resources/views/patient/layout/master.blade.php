                    ...
                    <div class="profile-sidebar">
                            ...
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    ...
                                    <div class="patient-details">
                                        <h5 class="mb-0">{{ucfirst(Auth::user()->role ?? '')}}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="dashboard-widget">
                            <nav class="dashboard-menu">
                                <ul>
                                    <li class="{{request()->is('patient_dashboard')=='true'?'active':''}}">
                                        <a href="{{url('patient_dashboard')}}">
                                            <i class="fas fa-columns"></i>
                                            <span>Dashboard</span>
                                        </a>
                                    </li>
                                    <li class="{{request()->is('patient_appointments')=='true'?'active':''}}">
                                        <a href="{{url('patient_appointments')}}">
                                            <i class="fas fa-columns"></i>
                                            <span>My Appointments</span>
                                        </a>
                                    </li>
                                    <li class="{{request()->is('manage_patient_profile')=='true'?'active':''}}">
                                        <a href="{{url('manage_patient_profile')}}">
